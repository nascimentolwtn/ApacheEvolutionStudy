...
import br.inpe.cap.evolution.visitor.AllDependenciesEvolutionOnlyVisitor;

public class AllDependencyOnlyOneVersionsEvolutionStudy implements Study {
	...
	private static final String EVOLUTION_LOG_PATH = STUDY_LOG_PATH + "evolutions-modOnly-HOME";
	
	private static final String FILE_PREFIX = "all_dependency_detector_openhab-modOnly-HOME";
	...
	public static void main(final String[] args) throws Exception {
		...
		AllDependenciesEvolutionOnlyVisitor.setLogger(log);
		Thread.currentThread().setName(FILE_PREFIX);
		
		checkRequiredLogFilesAndDirectories();
		AllDependenciesEvolutionOnlyVisitor.setContinueProperties(CONTINUE_COMMIT_FILE);
		
		new RepoDriller().start(new AllDependencyOnlyOneVersionsEvolutionStudy());
...
//			final CommitRange range = new OnlyInHead(); 
			new RepositoryMining()
				...
				.process(new AllDependenciesEvolutionOnlyVisitor(),
