...
import br.inpe.cap.evolution.processor.EffectivePomSynchronousCheckoutOnlyProcessor;
import br.inpe.cap.evolution.processor.LoggerCheckoutObserver;

public class AllDependenciesEvolutionOnlyVisitor implements CommitVisitor {
	...
	private EffectivePomSynchronousCheckoutOnlyProcessor effectivePomProcessor;
	...
	public void initialize(SCMRepository repo, PersistenceMechanism writer) {
		...
		this.effectivePomProcessor = new EffectivePomSynchronousCheckoutOnlyProcessor(new LoggerCheckoutObserver(logger), writer, totalCommits, logger, new ConfigurableMavenEffectivePom(OS.WIN8));
	}
	...
	public static void setLogger(final Logger logger) {
		AllDependenciesEvolutionOnlyVisitor.logger = logger;
	}
	
	public static void setContinueProperties(final File continueCommitFile) throws IOException {
		AllDependenciesEvolutionOnlyVisitor.continueCommitFile = continueCommitFile;
		AllDependenciesEvolutionOnlyVisitor.properties = new Properties();
