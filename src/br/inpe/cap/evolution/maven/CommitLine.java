...
public class CommitLine {
	...
	public static final String INPUT_HEADER = "HASH,DATE,REPOSITORY,FILE,COMMIT_POSITION,TOTAL_COMMITS,%_PROJECT,IS_MANAGED,GROUP_ID,ARTIFACT_ID,VERSION,MESSAGE";
	public static final String WRONG_INPUT_HEADER = "HASH,DATE,REPOSITORY,FILE,COMMIT_POSISTION,TOTAL_COMMITS,%_PROJECT,IS_MANAGED,GROUP_ID,ARTIFACT_ID,VERSION,MESSAGE";
	...
	public static final String INVISIBLE_CHAR0_OUTPUT_HEADER = "﻿HASH,DATE,REPOSITORY,FILE,COMMIT_POSITION,TOTAL_COMMITS,%_PROJECT,GROUP_ID,ARTIFACT_ID,VERSION,PREVIOUS_VERSION,VERSION_CHANGED,VERSION_EVER_CHANGED,MESSAGE";
	...
	private static boolean isLineAnyKindOfHeader(final String line) {
		return INPUT_HEADER.equals(line) ||
		   WRONG_INPUT_HEADER.equals(line) ||
